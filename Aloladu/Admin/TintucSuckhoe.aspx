<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="TintucSuckhoe.aspx.cs" Inherits="Aloladu.Admin.TintucSuckhoe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
         <div class="Nest-page">
    <div class="Nest-title">TIN TỨC &gt; SỨC KHỎE</div>
                ...
                <asp:TemplateField HeaderText="Tiêu đề" HeaderStyle-BackColor="#d9d9d9">
                    <ItemTemplate>
                        <a class="order-id-link"
                           href='<%# "TintucSuckhoeChitiet.aspx?id=" + Eval("Nest_ID") %>'>
                            <%# Eval("Nest_Title") %>
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
